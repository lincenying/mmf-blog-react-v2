                ...
                <div className="wrap">
                    <div className="left-part">
                        ...
                        <div className="main-nav">
                            <NavLink activeClassName="current" to="/" exact className='nav-link'><i className="icon icon-nav-home" /><span className="text">首页</span></NavLink>
                            <NavLink activeClassName="current" to="/trending/visit" className='nav-link'><i className="icon icon-nav-explore" /><span className="text">热门</span></NavLink>
                            <NavLink activeClassName="current" to="/about" className='nav-link'><i className="icon icon-nav-features" /><span className="text">关于</span></NavLink>
                        </div>
                    </div>
