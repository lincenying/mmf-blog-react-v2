...
const TopicsItem = props => {
    ...
    return (
        <div className="card feed">
            <div className="feed-content"> <span className="feed-time">{ item.update_date }</span><span className="feed-source">来自分类 <Link to={'/category/' + item.category} className="feed-minor-link">{item.category_name}</Link></span>
